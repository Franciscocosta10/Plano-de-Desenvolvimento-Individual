...
4. Como pretendo evoluir

Para alcançar esses objetivos, pretendo adotar algumas práticas ao longo do semestre:

Estudar regularmente os conteúdos apresentados em aula e revisar os conceitos após cada encontro.

Praticar resolução de exercícios e desafios de algoritmos para reforçar o aprendizado.

Utilizar plataformas de prática de programação para treinar lógica e resolução de problemas.

Desenvolver pequenos códigos e testes para aplicar na prática os conceitos aprendidos.

5. Indicadores de progresso (mensuráveis)

Para acompanhar minha evolução ao longo do semestre, pretendo utilizar alguns indicadores:

Resolver pelo menos 3 exercícios de algoritmos por semana.

Registrar no repositório exemplos de códigos desenvolvidos durante os estudos.

Conseguir implementar algoritmos vistos em aula sem depender totalmente de exemplos prontos.

Participar ativamente das atividades e desafios propostos na disciplina.
